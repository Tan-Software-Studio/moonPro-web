        ...
        <div className="h-screen flex flex-col">
            ...
            <div className="xl:w-[67%] w-full xl:pl-6 px-6 flex justify-start items-center gap-8">
              ...
              <div className="flex flex-col shrink-0 py-0.5">
                <div className="flex gap-2 onest w-full">
                  <p className="font-bold text-lg leading-6">
                    {shownMainStatData?.groupName || "Group Name"}
                  </p>
                  ...
                  {shownMainStatData?.topAdmin?.adminName && (
                    <>
                      <button
                        onClick={() =>
                          router.push(
                            `/caller-profile/${shownMainStatData?.topAdmin?.adminId}`
                          )
                        }
                ...
                <div className="flex gap-2 mt-2">
                  ...
                  {shownMainStatData?.inviteLink && (
                    <a
                      href={shownMainStatData?.inviteLink}
                      target="_blank"
              ...
              <div className="flex items-center justify-center flex-col shrink-0">
                <div className="flex gap-1 items-center">
                  ...
                  <Infotip
                    body={`Rank based on performance in ${readableTimeInterval(
                      activeIntervalAlphaMainStat
                    )}`}
                  />
                </div>
                <p className="font-spaceGrotesk font-bold text-4xl leading-[44px]">
                  #{shownMainStatData?.rank}
                </p>
              </div>
              ...
              <div className="flex justify-between w-full">
                <div className="flex flex-col items-center gap-1 py-4 onest">
                  <div className="flex gap-1 items-center">
                    ...
                    <Infotip
                      body={`Total Calls made in ${readableTimeInterval(
                        activeIntervalAlphaMainStat
                      )}`}
                    />
                  </div>
                  <div className="flex gap-[5px]">
                    ...
                    <p className="font-bold text-base leading-5">
                      {shownMainStatData?.topAdmin?.callsCount || 0}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-1 py-4 onest">
                  <div className="flex gap-1 items-center">
                    ...
                    <Infotip
                      body={`Highest performance call in ${readableTimeInterval(
                        activeIntervalAlphaMainStat
                      )}`}
                    />
                  </div>
                  <div className="flex gap-[5px]">
                    ...
                    <p className="font-bold text-base leading-5">
                      {formatNumberNoLoop(topCall?.performance)}x
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-1 py-4 onest">
                  <div className="flex gap-1 items-center">
                    ...
                    <Infotip
                      body={`Percentage of calls that reached 2x gains or more in ${readableTimeInterval(
                        activeIntervalAlphaMainStat
                      )}`}
                    />
                  </div>
                  <div className="flex gap-[5px]">
                    ...
                    <p className="font-bold text-base leading-5">
                      {shownMainStatData?.topAdmin?.winRate?.toFixed(2) || 0}%
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-1 py-4 onest">
                  <div className="flex gap-1 items-center">
                    ...
                    <Infotip
                      body={`Average gains from all calls in ${readableTimeInterval(
                        activeIntervalAlphaMainStat
                      )}`}
                    />
                  </div>
                  <div className="flex gap-[5px]">
                    ...
                    <p className="font-bold text-base leading-5">
                      {formatNumberNoLoop(
                        shownMainStatData?.topAdmin?.averagePerformance
                      )}
                      x
                    </p>
                  </div>
            ...
            <div className="xl:w-[37%] w-full xl:pr-6 px-6 flex justify-end items-center gap-4">
              ...
              <AlphaFollowButton
                ...
                isFollowing={
                  ...
                  alphaFollow.some((g) =>
                    g.groupType === "channel"
                      ? g.channelId === shownMainStatData?.channelId
                      : g.groupId === shownMainStatData?.groupId
                  )
                }
                onUnfollow={() => {
              ...
              <button
                ...
                className={`flex gap-2 items-center justify-center px-[29.5px] py-2.5 rounded-[4px] ${
                  shareCopied
                    ? "pointer-events-none bg-[#333333]"
                    : "bg-[#1F73FC] hover:bg-[#0E43BD] ease-out transition-colors duration-200"
                }`}
              >
                <p className="onest font-normal text-sm leading-4 text-[#F6F6F6]">
          ...
          <div className="flex xl:flex-row flex-col xl:justify-between justify-center items-start">
            ...
            <div className="xl:w-[67%] w-full xl:border-r border-[#4B4B4B]">
              ...
              <div
                ref={barChartRef}
                className="p-6 flex flex-col gap-1 border-b border-[#404040]"
              >
                  ...
                  <div className="flex flex-col gap-[3px] w-full">
                    <div className="w-full border-l border-b relative border-[#494949]">
                      {performanceRanges
                        .slice()
                        .reverse()
                        .map((performanceRow, index) => {
                          const value =
                            graphDataToShow?.topAdmin?.performanceCounts?.[
                              performanceRow?.key
                            ] || 0;
                          const barWidth = maxGraphValue
                            ? (value / maxGraphValue) * 100
                            : 0;
                              ...
                              <div
                                ...
                                style={{
                                  width: maxGraphValue
                                    ...
                                    : "0%",
                                  opacity:
                                    performanceOpacities?.[performanceRow?.key],
                                }}
                      ...
                      {!graphIsLoading && maxGraphValue === 0 && (
                        <div className="inset-0 absolute flex items-center justify-center trans">
                          <p className="text-[#6E6E6E]">
                            {noCallsFoundMessage(activeIntervalGraph)}
                          </p>
                        </div>
                      )}
                  ...
                  <div className="flex justify-between">
                        ...
                        <div class="flex justify-center items-center">
                          <label class="container flex items-center">
                            <input
                              ...
                              type="checkbox"
                              onChange={() =>
                                setShowAdminCallsOnly((prev) => !prev)
                              }
                            />
                            <span class="inline-block w-5 h-5 border-2 relative cursor-pointer after:content-[''] after:absolute after:top-2/4 after:left-2/4 after:-translate-x-1/2 after:-translate-y-1/2 after:w-[10px] after:h-[10px] after:bg-[#278BFE] after:rounded-[2px] after:opacity-0 peer-checked:after:opacity-100"></span>
                          </label>
                        </div>
                        <Tooltip
                          body={
                            "Displays only the calls made by admins from this alpha group."
                          }
                        >
                    ...
                    <button className="flex items-center justify-center gap-2 py-2.5 px-5">
                      <Image
                        ...
                        height={16}
                      />
                      <p className="onest font-normal text-xs leading-4 ">
                        Export
                      </p>
                    </button>
                  </div>
                    ...
                    <>
                      ...
                      <div className="mt-4 grid grid-cols-[0.25fr_1.25fr_1fr_1.5fr_0.5fr_0.75fr_0.75fr_0.75fr] w-full justify-between font-bold text-xs leading-4 onest text-[#A8A8A8]">
                        ...
                        <div className="flex gap-1 items-center">
                          ...
                          <Infotip
                            body={
                              "Shows the market cap of the token at the time it was called."
                            }
                          />
                        </div>
                        <div className="flex gap-1 items-center">
                          ...
                          <Infotip
                            body={
                              "Displays the all-time high (ATH) the token reached after the call."
                            }
                          />
                        </div>
                        <p>Gains</p>
                      ...
                      <div className="flex h-[421px] flex-col overflow-y-scroll overflow-hidden">
                        {displayAllCalls.map((call, index) => (
                          <div
                            key={index}
                            className="grid grid-cols-[0.25fr_1.25fr_1fr_1.5fr_0.5fr_0.75fr_0.75fr_0.75fr] w-full justify-between onest text-xs leading-4 py-2 border-b border-[#404040]"
                          >
                            ...
                            <p className="flex">
                              {call?.isAdmin === true ? "Yes" : "No"}
                            </p>
                            <p className="flex">
                              ${formatNumberNoLoop(call?.mc)}
                            </p>
                            <p className="flex">
                              ${formatNumberNoLoop(call?.athPostCallMc)}
                            </p>
                            <p className="flex">
                              x{formatNumberNoLoop(call?.performance)}
                            </p>
                          </div>
                        ))}
                      </div>
            ...
            {/* right side */}
            <div
              className="xl:w-[37%] w-full flex flex-col overflow-y-auto pb-16"
              style={{ height: `calc(100vh - 144px)` }}
            >
              {/* Recent / Top Call */}
              <div
                className="border-b border-[#404040]"
                style={{ height: barChartHeightRef }}
              >
                {/* Toggle Active */}
                <div className="px-6 pt-6 w-full font-normal text-sm leading-[18px] onest rounded-lg overflow-hidden flex text-[#6E6E6E]">
                  ...
                  <button
                    ...
                    className={`w-full gap-4 flex justify-center items-center rounded-lg ${
                      activeRecentCallsTab === "Top Call"
                        ? `bg-[#1F73FC] text-[#F6F6F6] py-0.5`
                        : `py-3`
                    }`}
                  >
                    <p>Top Calls</p>
                ...
                {/* Array Calls */}
                <div
                  className="p-6 overflow-hidden onest"
                  style={{ height: barChartHeightRef - 66 }}
                >
                  <div className="h-full flex flex-col gap-4 overflow-hidden overflow-y-scroll">
                    <div
                      ref={scrollContainerRef}
                      className="flex flex-col gap-4 h-full overflow-y-scroll"
                    >
                      {activeRecentCallsTab === "Recent Call" &&
                        recentCalls.map((call, index) => (
                          <div key={index} className="flex items-center gap-2">
                            <p className="font-normal text-base leading-5 text-[#4D4D4D] w-12">
                              #{index + 1}
                            </p>
                        ...
                        (topAdminSortedCalls?.length > 0
                          ...
                          : !topCallIsLoading && (
                              <div className="w-full h-full flex items-center justify-center text-[#6E6E6E]">
                                <p>
                                  {noCallsFoundMessage(activeIntervalTopCall)}
                                </p>
                              </div>
                            ))}
                    </div>
              ...
              <div className="border-b border-[#404040] p-6">
                <div className="flex items-center justify-center w-full h-[356px] bg-white text-black rounded-lg font-spaceGrotesk">
                  <p className="font-bold text-[40px] leading-[44px] text-center">
                    Wave
                    <br />
                    Banner/
                    <br />
