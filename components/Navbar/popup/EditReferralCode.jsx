"use client";
import { updateUserReferralId } from "@/app/redux/userDataSlice/UserData.slice";
            ...
            <div className="">
              ...
              <div className="px-2 py-2">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`mt-3 w-full rounded-lg text-sm py-2 font-semibold transition border ${
                    isLoading
                      ? "bg-[#11265B] cursor-not-allowed"
                      : "bg-[#11265B] hover:bg-[#133D94]"
                  }  border-[#0E43BD] text-white shadow-md`}
                >
                  {isLoading ? (
