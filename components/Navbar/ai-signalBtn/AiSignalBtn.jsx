            ...
            <Link href='/ai-signal'>
                {isSidebarOpen ?
                    <button className="button group relative inline-flex items-center sm:gap-3 gap-2 pag-1 sm:px-6 px-3 py-1.5  border-[1.5px] border-blue-500 rounded-md transition-all duration-300 ">
                        ...
                        <span className=" py-1 px-1.5  border-[1px] border-transparent   ease-in-out text-[14px]  cursor-pointer  sm:text-sm text-base font-medium text-blue-500 transition-all duration-300 group-hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.4)]">
                            AI Signals
                        </span>
                    </button>
