...
const PasswordPopup = ({ setIsPassword, setIsLoginPopup, email, setAuthName }) => {
    ...
    return (
        <>
            ...
            {otpPopup ? <OtpPopup email={email} setOtpPopup={setOtpPopup} jwtToken={jwtToken} setJwtToken={setJwtToken} setIsPassword={setIsPassword} setIsLoginPopup={setIsLoginPopup} /> :
                <div
                    ...
                    >
                        <div className='p-4'>
                            ...
                            <div className='flex  leading-none items-center justify-center'>
                                <h2 className="text-base text-center leading-none">Create password</h2>
                            </div>
                            <div className='mt-4'>
                            ...
                            <button
                                ...
                                className='bg-[#1f73fc] text-sm py-2 flex items-center  w-full mt-3 rounded-md justify-center'>Continue</button>
                        </div>
