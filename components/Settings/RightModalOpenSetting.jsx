...
const RightModalOpenSetting = ({
  ...
  useEffect(() => {
    ...
    if (preSetFromLocalStorage) {
      ...
      setPriorityForDisplay(
        preSetFromLocalStorage[preSetActiveFLag]?.buy?.priorityFee
      );
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div
        className={`flex flex-col justify-between fixed top-0 !z-[99999999981] h-svh bottom-5 transition-all duration-500 ease-in-out xl:w-[20%] lg:w-[30%]  w-full bg-[#08080e] border border-[#191919] ${
