                    ...
                    >
                        ...
                        >
                            ...
                            <div className='py-3 px-4 border-b border-[#2A2A2A]'>
                                <div className='flex items-center justify-between'>
                                    <div className='flex items-center gap-3'>
                                        <div className='text-[#FFFFFF] text-lg font-semibold'>Sell</div>
                                    </div>
                                    <IoMdClose
                                        size={20}
                                        onClick={(e) => {
                            ...
                            <div className='py-4'>
                                <div className='p-4'>
                                    <div>
                                        <div className='text-[#FFFFFF] text-sm mb-2'>Amount to Sell</div>
                                        ...
                                        <div className='text-xs text-red-500'>{isMoreAmount && "Amount entered is more than your available funds"}</div>
                                    </div>
                                ...
                                <div className='py-2 px-4'>
                                    {isLoading
                                        ?
                                        <button
                                            className='w-full bg-[#b91c1c] hover:bg-[#991b1b]   mt-4 overflow-x-hidden   text-white font-semibold py-2 rounded-full transition-all duration-200 text-sm'
                                        >
                                            selling...
                                        </button>
                                        :
