...
const SwapPopup = ({ onClose, perpsBalance, SolBalance }) => {
    ...
    // );
    // console.log("🚀 ~ SwapPopup ~ usdcLivePrice:", usdcLivePrice)    
        ...
        <>
            ...
            >
                <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                    className="LanguagePopup-lg max-w-sm sm:w-[90%] border border-gray-800 w-full bg-[#08080E] rounded-md !z-[999999999999999]"
                ...
                >
                    ...
                    <div className="p-4">
                        <div className='text-[#A8A8A8] text-xs mb-4 break-all'>Exchange Native Solana for USDC on Hyperliquid. The minimum deposit is 6 USDC.</div>
