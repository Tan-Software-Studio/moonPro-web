...
const SwapPopup = ({ onClose, perpsBalance }) => {
  ...
  const handleConfirmConvert = async () => {
    try {
      ...
      toast.success(response?.data?.message || "Deposite successfull.", {
        id: "transation-toast",
        duration: 2000,
      });
      setBtnLoading(false);
          ...
          <div className="p-4">
            <div className="flex flex-col h-full">
              <div className="mb-2">
                <div className=" bg-[#1D1E26] rounded-lg px-4 py-3 text-white text-sm">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-gray-400 text-xs font-medium">
                      Balance: {activeSolWalletAddress?.balance}
                    </div>
                  </div>
              ...
              <div className="flex justify-center my-2">
                <button className="bg-[#2A2A2A] hover:bg-[#3A3A3A] p-2 rounded-full transition-colors">
              ...
              <div className="text-[#A8A8A8] text-[10px] mb-4 mt-4 break-all">
                NOTE: Exchange Native Solana for USDC on Hyperliquid. The
                minimum deposit is 7 USDC.
              </div>
              ...
              <div className="mt-auto">
                {btnLoading ? (
                  ...
                  <button
                    ...
                    disabled={usdcInputAmount < 6 || btnLoading}
                  >
                    Confirm
                  </button>
                )}
