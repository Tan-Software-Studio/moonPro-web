...
const BuySell = () => {
  ...
  async function handleOrderPlace() {
    try {
      ...
      const tokenPrice =
        orderType == "Limit"
          ? Number(limitPriceInput)
          : Number(selectedToken?.markPx);
  ...
  return (
    <>
      <div className="lg:overflow-auto lg:max-h-[90vh] h-full text-white xl:p-4 p-1.5 w-full lg:max-w-sm mx-auto">
            ...
            <div className=" bg-[#1D1E26] rounded-lg px-4 py-3 text-white text-sm">
              <div className="flex justify-between items-center">
                ...
                <div className="text-gray-400">
                  {selectedToken ? selectedToken?.markPx : "0"}
                </div>
              </div>
        ...
        <div className="space-y-3 mt-5 text-xs">
          ...
          <div className="flex justify-between">
            ...
            <div className="text-white">
              {spotBalance?.total ? Number(spotBalance?.total).toFixed(2) : "0"}{" "}
              USDC
            </div>
          </div>
          <div className="flex justify-between">
      ...
      {isSwapPopup ? (
        <SwapPopup onClose={setIsSwapPopup} perpsBalance={perpsBalance} />
      ) : null}
